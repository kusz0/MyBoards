...
namespace MyBoards.Migrations
{
    ...
    [Migration("20260216194938_additionalWorkItemSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItems.WorkItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItems.Epic", b =>
                {
                    b.HasBaseType("MyBoards.Entities.WorkItems.WorkItem");
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItems.Issue", b =>
                {
                    b.HasBaseType("MyBoards.Entities.WorkItems.WorkItem");
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItems.Task", b =>
                {
                    b.HasBaseType("MyBoards.Entities.WorkItems.WorkItem");
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItemTag", b =>
                {
                    ...
                    b.HasOne("MyBoards.Entities.WorkItems.WorkItem", "WorkItemT")
                        .WithMany()
                        .HasForeignKey("WorkItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyBoards.Entities.WorkItems.WorkItem", b =>
                {
                    ...
                    b.HasOne("MyBoards.Entities.State", "State")
                        .WithMany("WorkItems")
